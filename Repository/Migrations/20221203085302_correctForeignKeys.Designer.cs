...
namespace Repository.Migrations
{
    ...
    [Migration("20221203085302_correctForeignKeys")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Repository.Model.Book.BookAuthor", b =>
                {
                    b.HasOne("Repository.Model.Book.Author", "Author")
                        .WithOne("BookAuthor")
                        .HasForeignKey("Repository.Model.Book.BookAuthor", "AuthorId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Repository.Model.Book.Book", "Book")
                        .WithOne("BookAuthor")
                        .HasForeignKey("Repository.Model.Book.BookAuthor", "BookId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
